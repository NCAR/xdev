...
next year (July 2020 - June 2021).  Each individual activities shows
the number of *points* that members of the Xdev Team gave to each
Activity.  I have prioritized each Activity in order of the most
points, and I have not shown any Activity ideas that were given zero
points.  I have also attempted to take any comments made about each
Activity during the discussion section of the exercise and scope
out general project ideas for each Activity.
...
that we identified as something we should *Start*.  As a result, I only include
the *Start* Activities in the section above.  (The points allocated to each *Stop*
Activity was added to its mirror *Start* Activity and are listed as [I+J points].)
