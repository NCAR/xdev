...
BLOG_DESCRIPTION = "Experimenting. Prototyping."  # (translatable)
...
LOGO_URL = '/assets/img/xdev_logo.png'
...
# (translatable)
CONTENT_FOOTER = '<a href="https://www.ucar.edu/">University Corporation for Atmospheric Research</a> © {date}<br>Proudly published with <a href="https://getnikola.com/">Nikola</a> &amp; <a href="https://pages.github.com/" target="_blank" rel="noopener">GitHub Pages</a><br>{license}'
...
RSS_COPYRIGHT = 'Contents © {date} UCAR {license}'
RSS_COPYRIGHT_PLAIN = 'Contents © {date} UCAR {license}'
...
# is in the manual.
COMMENT_SYSTEM_ID = "ncar-xdev-blog"
...
TWITTER_CARD = {
    ...
    'site': '@NCARXdev',        # twitter nick for the website
...
#    'BANNER_URL': '/assets/img/mammatus.jpg'
